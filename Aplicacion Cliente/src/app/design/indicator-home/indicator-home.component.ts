...
export class IndicatorHomeComponent implements OnInit {
  ...
  constructor() {
    this.data = [{
      ...
      details: [
        { title: 'Nº DE NUEVAS ENTIDADES INTERNACIONALES VINCULADAS AL CET', value: 356 },
        { title: 'Nº DE NUEVAS ENTIDADES NACIONALES VINCULADAS AL CET', value: 126 },
        { title: 'N° EMPRESAS PARTICIPANTES EN ACTIVIDADES DE CAPACITACIÓN ASOCIATIVAS', value: 274 },
        { title: 'N° APARICIONES EN PRENSA DIGITAL Y ESCRITA', value: 274 },
        { title: 'Nº DE ACTVIDADES DE DIFUSIÓN EN LA QUE EL CET PARTICIPA', value: 274 },
      ]
    },
    {
      title: 'Vinculación con Académicos y Estudiantes',
      details: [
        { title: 'Nº de académicos que participan en actividades del CET', value: 356 },
        // tslint:disable-next-line:max-line-length
        { title: 'Nº de estudiantes que realizan sus prácticas, tesis, proyectos de mejoramiento, memoria u otra actividad afín al CET', value: 126 }
      ]
    },
    {
      // tslint:disable-next-line:max-line-length
      ...
      details: [
        ...
        { title: 'Nº de extensionistas y profesionales del Centro formados', value: 126 }
      ]
    },
    {
      ...
      details: [
        ...
        { title: 'N° de empresas asesoradas individualmente o en proceso de asesoria.', value: 126 },
        { title: '% porcentaje de intervenciones efectivamente realizadasS', value: 274 },
